...
const FIELD_HINTS: Record<string, string> = {
  ...
  'springs.typeWeakScale': 'spring scale, weak influence declarations',
  'springs.typeMidScale': 'spring scale, mid influence declarations',
  'springs.typeStrongScale': 'spring scale, strong influence declarations',
